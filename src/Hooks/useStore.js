...
export const useStore = (key) => {
    ...
    useEffect(() => {
        const fetchStore = async () => {
            ...
            const url = `/.netlify/functions/proxyGet?keyword=${key}&centerY=36.84950309992622&centerX=127.15437257867464&minY=36.845258941966016&maxY=36.8530782657718&minX=127.14723334692333&maxX=127.16278946667573`;            // console.log(url);
            try {
